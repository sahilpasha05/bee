...
app.post('/export-docx', (req, res) => {
    ...
    function getChartsForSection(title, content) {
        ...
        const candidates = [
            ...
            ['implementation_roadmap','recommendation',18,6,'Figure: Implementation Roadmap'],
            ['implementation_roadmap','implementation plan',18,6,'Figure: Implementation Roadmap'],
            ['ux_principles_radar','usability',9,9,'Figure: UX Principles Radar'],
            ['ux_principles_radar','interaction design',9,9,'Figure: UX Principles Radar'],
            ['interaction_paradigm','interaction paradigm',14,5,'Figure: Interaction Paradigm Comparison'],
            ['interaction_paradigm','paradigm',14,5,'Figure: Interaction Paradigm Comparison'],
            ['ethical_framework','ethical',14,5,'Figure: Ethical Framework Matrix'],
            ['ethical_framework','ethics',14,5,'Figure: Ethical Framework Matrix'],
            ['heuristic_evaluation','heuristic',14,5,"Figure: Nielsen's Heuristics Evaluation"],
            ['heuristic_evaluation','usability evaluat',14,5,"Figure: Nielsen's Heuristics Evaluation"],
        ];
